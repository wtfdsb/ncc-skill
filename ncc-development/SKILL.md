---
name: ncc-development
description: Use when developing, extending, diagnosing, deploying, or testing NCC/NCCloud business modules involving BMF metadata, generated Java, React index.js, page templates, custom references, Action/Authorize XML, Oracle tables, application registration, permissions, approval flows, or .do requests.
---
...
- Project roots and locating files across NCC modules: read [project-map.md](references/project-map.md).
...
```powershell
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ./scripts/check-ncc-module.ps1 -Root '<NCC_WORKSPACE>' -Module qualityobjection -AppCode 90HA0707
```
